...
#define ERR_NOSUCHNICK(nickname)					": IRC 401 * " + nickname + " :No such nick/channel\r\n"
#define ERR_NOSUCHSERVER(servername)				": IRC 402 * " + servername + " :No such server\r\n"
#define ERR_NOSUCHCHANNEL(channelname)				": IRC 403 * " + channelname + " :No such channel\r\n"
#define ERR_CANNOTSENDTOCHAN(channelname)			": IRC 404 * #" + channelname + " :Cannot send to channel\r\n"
#define ERR_TOOMANYCHANNELS(channelname)			": IRC 405 * #" + channelname + " :You have joined too many channels\r\n"
#define ERR_WASNOSUCHNICK(nickname)					": IRC 406 * " + nickname + " :There was no such nickname\r\n"
...
#define ERR_NORECIPIENT(command)					": IRC 411 * :No recipient given " + command + "\r\n"
#define ERR_NOTEXTTOSEND							": IRC 412 * :No text to send\r\n"
...
#define ERR_ERRONEUSNICKNAME(nickname)				": IRC 432 * " + nickname + " :Erroneus nickname\r\n"
#define ERR_NICKNAMEINUSE(nickname)					": IRC 433 * " + nickname + " :Nickname is already in use\r\n"
#define ERR_NICKCOLLISION(nickname)					": IRC 436 * " + nickname + " :Nickname collision KILL\r\n"
#define ERR_USERNOTINCHANNEL(nickname, channel)		": IRC 441 * " + nickname + " #" + channel + " :They aren't on that channel\r\n"
#define ERR_NOTONCHANNEL(channel)					": IRC 442 * #" + channel + " :You're not on that channel\r\n"
#define ERR_USERONCHANNEL(nickname, channel)		": IRC 443 * " + nickname + " #" + channel + " :is already on channel\r\n"
#define ERR_NOLOGIN(nickname)						": IRC 444 * " + nickname + " :User not logged in\r\n"
...
#define ERR_NEEDMOREPARAMS(command)					": IRC 461 * " + command + " :Not enough parameters\r\n"
#define ERR_ALREADYREGISTRED						": IRC 462 * :You may not reregister\r\n"
...
#define	RPL_AWAY(nickname, message)					": IRC 301 * " + nickname + " :" + message + "\r\n"
...
#define	RPL_NOTOPIC(channel)						": IRC 331 * " + channel + " :No topic is set\r\n"
#define RPL_TOPIC(channel, topic) 					": IRC 332 * " + channel + " :" + topic + "\r\n"
